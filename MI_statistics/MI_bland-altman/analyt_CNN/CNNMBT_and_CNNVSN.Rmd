...
<!-- version -->
<div align=right>
<font style="color:#26a169; font-size:80%">Processed: 2024.08.30 13:43</font>
</div>
...
(Intercept)      0.001        0.019     0.057      0.955     -0.040      0.04314.000
         IV     -0.846        0.178    -4.755      0.000     -1.227     -0.46414.000


Multiple R-squared: 0.5246,  Adjusted R-squared: 0.4906
F-statistic: 22.6 on 1 and 14 DF, p-value: 3.074e-04
...
Decision by 95% confidence interval:
	avg{CNNVSN - CNNMBT} = 0.0011 + -0.8458 {CNNMBT - mean(CNNMBT)}

	H0: accuracy point(0,0) inside 95% CI [-0.0598, 0.062] is not rejected
	n: 16 data pairs
	Bias 95%CI: between -0.0598 and 0.062.
...
Coefficients:
              Estimate   Std. Error   t value   Pr(>|t|)   CI Lower   CI Upper   DF
(Intercept)      0.283        0.299     0.946      0.360     -0.359      0.92414.000
         IV     -0.331        0.342    -0.969      0.349     -1.064      0.40214.000


Multiple R-squared: 0.0398,  Adjusted R-squared: -0.0288
F-statistic: 0.9 on 1 and 14 DF, p-value: 0.349037
...
Decision by 95% confidence band:
	avg{CNNVSN - CNNMBT} = 0.2829 + -0.3312 {(CNNMBT + CNNVSN)/2}

	H0: precision line horizontal (x,0)
	with translation from -0.0598 to 0.062 inside 95% CB is not rejected
	n: 16 data pairs
</pre>
```{r, echo=FALSE, out.width = "90%"}
...
Decision by 95% confidence band:
	avg{True[CNNVSN]} = 0.6531 + 0.2331 {True[CNNMBT]}
...
Decision by 95% confidence ellipse:
	...
	H0: intercept = [-0.0598,0.062], slope = 1 inside 95% ellipse is not rejected
	n: 16 data pairs
</pre>
```{r, echo=FALSE, out.width = "90%"}
