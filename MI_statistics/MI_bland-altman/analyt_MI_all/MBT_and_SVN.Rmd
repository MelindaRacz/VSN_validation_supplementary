...
<!-- version -->
<div align=right>
<font style="color:#26a169; font-size:80%">Processed: 2024.08.30 14:26</font>
</div>
...
(Intercept)     -0.022        0.022    -0.999      0.335     -0.068      0.02514.000
         IV     -0.684        0.242    -2.825      0.014     -1.204     -0.16514.000


Multiple R-squared: 0.3313,  Adjusted R-squared: 0.2835
F-statistic: 8 on 1 and 14 DF, p-value: 0.013507
...
Decision by 95% confidence interval:
	avg{SVN - MBT} = -0.0217 + -0.6844 {MBT - mean(MBT)}

	H0: accuracy point(0,0) inside 95% CI [-0.0899, 0.0463] is not rejected
	n: 16 data pairs
	Bias 95%CI: between -0.0899 and 0.0463.
...
Coefficients:
              Estimate   Std. Error   t value   Pr(>|t|)   CI Lower   CI Upper   DF
(Intercept)     -0.049        0.238    -0.205      0.841     -0.559      0.46114.000
         IV      0.034        0.302     0.112      0.912     -0.613      0.68114.000


Multiple R-squared: 5e-04,  Adjusted R-squared: -0.0708
F-statistic: 0 on 1 and 14 DF, p-value: 0.912357
...
Decision by 95% confidence band:
	avg{SVN - MBT} = -0.0487 + 0.0338 {(MBT + SVN)/2}

	H0: precision line horizontal (x,0)
	with translation from -0.0899 to 0.0463 inside 95% CB is not rejected
	n: 16 data pairs
</pre>
```{r, echo=FALSE, out.width = "90%"}
...
Decision by 95% confidence band:
	avg{True[SVN]} = 0.2592 + 0.6528 {True[MBT]}
...
Decision by 95% confidence ellipse:
	...
	H0: intercept = [-0.0899,0.0463], slope = 1 inside 95% ellipse is not rejected
	n: 16 data pairs
</pre>
```{r, echo=FALSE, out.width = "90%"}
